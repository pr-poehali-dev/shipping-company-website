        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <img
                src="https://cdn.poehali.dev/files/261b3924-1409-4248-8ce1-eee9bcf86100.jpeg"
            ...
            <Card className="border-2">
              ...
              <CardContent>
                <p className="text-base text-muted-foreground leading-relaxed mb-4">
                  T-SHIPPING LIMITED's Commercial Management Team provides services of cargo transportation by its own ocean-going vessel as well as by the ocean-going and river-sea vessels of our associates and business partners. We also provide commercial management including fleet chartering and operation.
                </p>
                <p className="text-base text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            ...
            <Card className="border-2 overflow-hidden">
              <div className="h-48 overflow-hidden">
                <img 
                  src="https://cdn.poehali.dev/files/dfe2c87a-eb51-4ba8-a2fb-77639c8a9483.jpeg"
                  alt="Tanker"
                  className="w-full h-full object-cover"
                />
              </div>

            ...
            <Card className="border-2">
              ...
              <CardContent>
                <p className="text-base text-muted-foreground leading-relaxed mb-4">
                  Commercial Management T-SHIPPING LIMITED's Commercial team Management provides services of cargo transportation by its own ocean-going vessel as well as by the ocean-going and river vessels of our associates and business partners. We also provide commercial management including fleet chartering and operation.
                </p>
                <p className="text-base text-muted-foreground leading-relaxed mb-4">
